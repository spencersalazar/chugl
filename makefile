...
chugl_opengles.cpp: OpenGL/gl.xml ck.py genchugin-es.py
	PYTHONPATH="PYTHONPATH:OpenGL" python genchugin-es.py
...
clean: 
	rm -rf $(OBJS) $(CHUG) *.o Release Debug chugl_opengl.cpp gl/*.o gles/*.o
